...
basicLinks::basicLinks(SST::ComponentId_t id, SST::Params& params) : Component(id) {
    ...
    registerClock("1GHz", new SST::Clock::Handler<basicLinks>(this, &basicLinks::clockTic));
    ...
    // 1. These links share
    linkHandler = configureLink("port_handler", new SST::Event::Handler<basicLinks>(this, &basicLinks::handleEvent));
    ...
    while (isPortConnected(linkname)) {
        SST::Link* link = configureLink(linkname, new SST::Event::Handler<basicLinks, int>(this, &basicLinks::handleEventWithID, portnum));
 ...
 */
bool basicLinks::clockTic(SST::Cycle_t cycleCount)
{
