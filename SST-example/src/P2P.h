...
class P2P: public SST::Component
{
public:


    SST_ELI_REGISTER_COMPONENT(
        p2pSimulation,                       // Component class
        "p2pSimulation",         // Component library (for Python/library lookup)
        "cpu",                     // Component name (for Python/library lookup)
        SST_ELI_ELEMENT_VERSION(1,0,0), // Version of the component (not related to SST version)
        "A Simple P2P Simulation",        // Description
    ...
    P2P(SST::ComponentId_t id, SST::Params& params);
    ~P2P();
    void showVectorSum();
